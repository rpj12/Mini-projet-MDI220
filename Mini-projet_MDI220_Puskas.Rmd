...
Or d'apres les donnees, il vient : $k=20$ et $\theta = 0.25$. 
...
L'estimateur du maximum de vraisemblance s'exprime comme : $ \hat\beta = \frac{\sum_{i=1}^{n} x_i}{nk'} = \frac{\sum_{i=1}^{n} x_i}{n\sum_{i=1}^{n} x_i+k}$
